            ...
            <div className="row py-[100px]">
                <div className="container mx-auto">
                    <div className="grid md:grid-cols-3 grid-cols-1 gap-10 ">
                        <div className="relative before:content-[''] before:absolute before:block md:before:h-[300px] md:before:w-[600px] before:border-2 before:border-[#2BB673] before:rounded-tr-[150px] before:rounded-br-[150px] md:before:top-[-30px] md:before:left-[150px] z-[-10] before:top-[-30px] before:left-[100px] before:h-[300px] before:w-[320px] px-3">
                            <div className="bg-[#128041] md:h-full h-[405px] w-[300px] md:m-auto flex flex-col justify-center items-center rounded-md z-10 relative ml-5">
                                <div className="">
                        ...
                        <div className="md:col-span-2">
                            <div className="bg-[#F9F9F9] w-[85%] py-10 md:px-10 rounded-md m-auto shadow">
